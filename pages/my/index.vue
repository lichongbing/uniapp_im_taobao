    ...
    <view class="page">
        ...
        <uni-list class="list" style="margin-top: 14px;">
		   ...
		   <uni-list-item title="帮助中心"
			...
			<uni-list-item title="我的邀请"
						  :showArrow="true"
						  thumb="../../static/theme/default/help.png"
						  @click="goPath('../invitation/invitation?user_id='+my_data.id)"/>
			<view class="uni-list-cell">
				<view class="uni-list-cell-navigate">
					<view style="display: flex;width: 100%;justify-content: space-between;">
						<view style="display: flex;">
							<text>邀请码:</text>
							<view class="show_text">{{my_data.code}}</view>
						</view>
						<view class="copy" @tap="paste(my_data.code)">复制</view>
					</view>
				</view>
			</view>
