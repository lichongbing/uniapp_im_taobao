<template>
	<view class="zai-box">
		...
		<view class="zai-form">
			...
			<input class="zai-input"  v-model="form.code" v-show="form.code_coerce"  placeholder="请输入邀请码(必填)" />
			<input class="zai-input"  v-model="form.code" v-show="!form.code_coerce"  placeholder="请输入邀请码(选填)" />
